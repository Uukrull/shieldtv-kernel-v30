...
#
ifneq ($(filter loki% foster%,$(TARGET_PRODUCT)),)
_tmake_bootloader_products_path := -products/foster-loki
else ifneq ($(filter hawkeye%,$(TARGET_PRODUCT)),)
_tmake_bootloader_products_path := -products/hawkeye
else
...
_tmake_intermediates := $(_tmake_intermediates)_$(_tmake_config_device)_$(TARGET_BUILD_TYPE)
_tmake_config_debug  := $(_tmake_target_debug)
_tmake_part_umbrella := bootloader/cboot$(_tmake_bootloader_products_path)/build/Makefile.$(LOCAL_NVIDIA_TMAKE_PART_NAME)
...
_tmake_intermediates := $(_tmake_intermediates)_$(_tmake_config_device)_$(TARGET_BUILD_TYPE)
_tmake_config_debug  := $(_tmake_target_debug)
_tmake_part_umbrella := bootloader/nvtboot$(_tmake_bootloader_products_path)/build/Makefile.$(LOCAL_NVIDIA_TMAKE_PART_NAME)
...
_tmake_intermediates := $(_tmake_intermediates)_$(HOST_BUILD_TYPE)_$(TARGET_BUILD_TYPE)
_tmake_config_debug  := $(_tmake_host_debug)
_tmake_part_umbrella := bootloader/cboot$(_tmake_bootloader_products_path)/tegraflash/build/Makefile.$(LOCAL_NVIDIA_TMAKE_PART_NAME)
