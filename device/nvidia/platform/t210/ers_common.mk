...
PRODUCT_COPY_FILES += \
  ...
  $(LOCAL_PATH)/jetson_e_media_profiles.xml:system/etc/jetson_e_media_profiles.xml \
  $(LOCAL_PATH)/jetson_cv_media_profiles.xml:system/etc/jetson_cv_media_profiles.xml \
